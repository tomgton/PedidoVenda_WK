...
public
  ...
  procedure criaItensPedido;
  procedure cancelaItensPedido;
  procedure listarItensPedido;
...
procedure TItensPedido.cancelaItensPedido;
...
procedure TItensPedido.criaItensPedido;
var QryItemPedido : TFDQuery;
begin
  QryItemPedido := TFDQuery.Create(nil);
  QryItemPedido.Connection := dmConexoes.Conexao;
...
procedure TItensPedido.listarItensPedido;
...
procedure TItensPedido.SetQry(const Value: TFDMemTable);
begin
  FQry := Value;
end;
